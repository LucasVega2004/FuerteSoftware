...
<body>
    ...
    <form action="../sql/tareas_sql.php?op=insertar" class="rounded-3" method="post">
        <div class="ms-5 mb-3 w-75 mt-2">
            ...
            <input type="text" name="NombreProyecto" class="form-control" id="exampleInputEmail1"
                aria-describedby="emailHelp" maxlength="45" required>
        </div>
        ...
        <div class="ms-5 mb-3 w-75 mt-2">
            ...
            <input type="text" name="Tipo" maxlength="45" class="form-control" id="exampleInputEmail1"
                aria-describedby="emailHelp" required>
        </div>

        <div class="ms-5 mb-3 w-75">
            <label for="cliente" class="form-label">Cliente: </label>
            <select name="idClientes" class="form-select" id="clientes">
